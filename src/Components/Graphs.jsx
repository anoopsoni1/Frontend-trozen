    ...
    <div className="w-screen h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 p-6 overflow-hidden">
          ...
          <div className="flex-1">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="Bio" stroke="#82ca9d" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
          ...
          <div className="flex-1">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="Commerce" fill="#ffc658" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        {/* Graph 4: Arts & Humanities */}
         <div className="p-4 shadow rounded-2xl bg-white flex flex-col">
          <h2 className="text-xl font-semibold mb-2 text-center">Arts and Humanities</h2>
          <div className="flex-1">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data}>
                <CartesianGrid strokeDasharray="3 3" />
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="Arts" stroke="#82ca9d" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
